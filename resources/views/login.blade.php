	...
	<div class="flex flex-col items-center justify-center py-12">
		<div class="w-full max-w-md p-6 border rounded-xl bg-card shadow-sm">
            <div class="flex flex-col space-y-1.5 mb-6">
                <h3 class="text-2xl font-semibold leading-none tracking-tight text-center">Accedi</h3>
                <p class="text-sm text-center text-muted-foreground">Inserisci le tue credenziali per continuare.</p>
            </div>
            ...
            <form action="{{ route('login.attempt') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" name="email" id="email" placeholder="nome@esempio.it" value="{{ old('email') }}"
